...
interface BasisTheoryDemoProps {
  jwt: string;
}

export function Playground({ jwt }: BasisTheoryDemoProps) {
  ...
  // Initialize private JWT on mount
  useEffect(() => {
    const initializePrivateJWT = async () => {
      try {
